...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color:#FADADD">
  <div class="container">
    <a class="navbar-brand " href="index.php"><img src="asset/logo.png" alt="" class="img-fluid " style="width: 60px;"></a>
      ...
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="product.php">Products </a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="user.php">Orders </a>
                </li>
            <li class="nav-item">
